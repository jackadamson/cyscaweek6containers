...
# This function initializes the python chroot. if unsuccessful it will exit
# the python program. if successful it will return as the child process
def initialize_chroot(CHROOT_USER_ID, CHROOT_GROUP_ID):
    ...
    # Set uid and gid
    print("Dropping privs to user %d group %d" % (CHROOT_USER_ID,
                                                  CHROOT_GROUP_ID))
    try:
    ...
    if fork_pid != 0:
        ...
        print("Fork succeeded. Parent going to sleep")
